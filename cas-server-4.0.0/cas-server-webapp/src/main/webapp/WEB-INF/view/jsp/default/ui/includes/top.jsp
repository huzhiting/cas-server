...
<body id="cas" class="fl-theme-iphone">
  <!-- <div id="container">
    <header>
      ...
      <div id="content"> -->
	<div class="flc-screenNavigator-view-container" style="padding-left:10px;padding-right:10px;">
	<div class="fl-screenNavigator-view"> 
	<div id="header" class="flc-screenNavigator-navbar fl-navbar fl-table">
		<a id="logo" href="http://www.jasig.org" title="<spring:message code="logo.title" />"></a>
        <h2 id="app  -->-name" style="font-size:25px;  height:44px; top:50px;margin-top:20px;" class="fl-table-cell">高校云平台 ITOO_5.0</h2>
    </div>		
